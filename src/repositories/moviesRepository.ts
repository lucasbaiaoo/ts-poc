...
export function moviesConflictVerificationRepository(): Promise<QueryResult>{
    return connectionDB.query("SELECT * FROM movies;")
}

export function getMoviesRepository(): Promise<QueryResult>{
    return connectionDB.query("SELECT * FROM movies;")
}

export function getMoviesIdsRepository(): Promise<QueryResult>{
    return connectionDB.query("SELECT id FROM movies;")
}

export function getMovieByIdRepository(id: number): Promise<QueryResult>{
